...
Meter((T_ODD_FOOT, T_EVEN_FOOT_CORRER,
       T_ODD_FOOT, T_EVEN_FOOT_CORRER,
       T_ODD_FOOT, T_FINAL_FOOT_CORRER), "trimeterCORRER")
Meter((T_ODD_FOOT, T_ODD_FOOT, T_ODD_FOOT, T_ODD_FOOT, T_ODD_FOOT, T_FINAL_FOOT), "trimeterDATI")
